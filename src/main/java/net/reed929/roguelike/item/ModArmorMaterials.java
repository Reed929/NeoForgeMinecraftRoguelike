...
public class ModArmorMaterials {
    public static ResourceKey<EquipmentAsset> BLOODSTONE = EquipmentAssets.createId("bloodstone");

    public static final ArmorMaterial BLOODSTONE_ARMOR_MATERIAL = new ArmorMaterial(1200,
            ...
            2f, 0.1f, ModTags.Items.BLOODSTONE_REPAIRABLE, BLOODSTONE);
}