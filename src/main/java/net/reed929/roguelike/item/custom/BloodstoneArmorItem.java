...
public final class BloodstoneArmorItem extends ArmorItem implements GeoItem {
    ...
    public BloodstoneArmorItem(Holder<ArmorMaterial> material, ArmorItem.Type type, Properties properties) {
